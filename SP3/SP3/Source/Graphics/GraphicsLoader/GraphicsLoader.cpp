...
unsigned GraphicsLoader::GetGPassShaderID()
{
	return this->m_gPassShaderID;
}

DepthFBO GraphicsLoader::GetLightDepthFBO()
{
	return m_lightDepthFBO;
}
...
GraphicsLoader::RENDER_PASS GraphicsLoader::GetRenderPass()
{
	return m_renderPass;
}